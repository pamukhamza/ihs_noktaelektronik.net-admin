...
$password = "Dell28736.!";
$database = "noktaelektronik_nokta";
...
$q = $db->prepare("SELECT * FROM siparisler WHERE durum IN (3, 4)");
$q->execute();
                    ...
                    if (isset($shippingDeliveryDetailVO->operationCode)) {
                        ...
                        if ($operationCode == 1) {
                            if($siparis['durum'] == 3) {
                                ...
                                $updateQuery = $db->prepare("UPDATE siparisler SET durum = 4, kargo_durumu = :kargo, kargo_no = :kargo_no WHERE barkod = :barkod");
                            ...
                            if($siparis['durum'] == 4) {
                                ...
                                $updateQuery = $db->prepare("UPDATE siparisler SET durum = 5, kargo_durumu = :kargo WHERE barkod = :barkod");
                                $siparis_no = $siparis['siparis_no'];
                                $sip_id = $siparis['id'];
                                $uye_email = $siparis['uye_email'];
                            ...
                            $updateQuery = $db->prepare("UPDATE siparisler SET kargo_durumu = :kargo WHERE barkod = :barkod");
                        }
