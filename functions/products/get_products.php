...
$mainQuery = "
    SELECT SQL_CALC_FOUND_ROWS p.id, p.UrunKodu, p.UrunAdiTR, p.seo_link, p.web_net, p.web_comtr, p.web_cn, p.DSF4, p.DSF3, p.DSF2, p.DSF1, DOVIZ_BIRIMI,
           m.id AS mid, m.title, 
