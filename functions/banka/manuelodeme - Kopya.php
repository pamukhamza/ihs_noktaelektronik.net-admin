...
if (isset($_GET['cariveri']) || isset($_GET['cariveriFinans'])) {
    ...
    if(isset($_GET['cariveri'])) {
        ...
        header("Location: https://www.noktaelektronik.net/admin/pages/b2b/b2b-sanalpos?w=noktab2b&cari_odeme=");
        ...
        try {
            ...
            if ($xmlResponse->ProcReturnCode == "00") {              
                ...
                header("Location: https://www.noktaelektronik.net/admin/pages/b2b/b2b-sanalpos?w=noktab2b&code=".$xmlResponse->ProcReturnCode."&message=".$xmlResponse->ErrMsg);
            }
            curl_close($ch);
        }
        catch (Exception $e) {
