...
<?php } elseif(isset($_POST["adminCariOdeme"])){
    $verimiz = [
        "cardHolder" => $_POST['cardName'],
        "cardNo" => $_POST['cardNumber'],
        "yantoplam" => $_POST["toplam"],
    ...
    $orgClientId  =   "280624575";
    $orgAmount = $odemetutar;
    $orgOkUrl =  "https://www.noktaelektronik.com.tr/admin/muhasebe/manualodeme?cariveriFinans=" . $verimizB64;
    $orgFailUrl = "https://www.noktaelektronik.com.tr/admin/muhasebe/adminManuelOdeme.php";
    $orgTransactionType = "Auth";
    $orgInstallment = $_POST['odemetaksit'];
    $orgRnd =  microtime();
    $orgCallbackUrl = "https://www.noktaelektronik.com.tr/php/bank/turkiye_finans/callback.php";
