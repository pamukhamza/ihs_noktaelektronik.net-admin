            ...
            "columns": [
                ...
                { data: 'durum' },
                {
                    ...
                    render: function(data, type, full, meta) {
                        return '<button type="button" name="tdpDuzenle" value="Düzenle" class="btn btn-sm btn-outline-light edit-tdp-duzenle" data-tdp-id="'+data+'"><i class="far fa-edit"></i></button>' +
