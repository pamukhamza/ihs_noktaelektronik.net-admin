                            ...
                            <div class="card-header px-0 pt-0">
                                <div class="nav-align-top">
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <button type="button" class="nav-link" data-bs-toggle="tab" data-bs-target="#form-tabs-b2b-urun" aria-controls="form-tabs-b2b-urun" role="tab" aria-selected="false"><span class="d-sm-none">B2B Ürünler Sayfası</span><span class="d-none d-sm-block">B2B Ürünler Sayfası</span></button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
