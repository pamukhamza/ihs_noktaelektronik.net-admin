                        ...
                        <div class="card p-2">
                            <div class="table-responsive">
                                <table id="sepetlerTable" class="table table-bordered ">
                                    ...
                                    ?>
                                        <tr>
                                            <td><?= !empty($sepet['ad']) && !empty($sepet['soyad']) ? $sepet['ad'] .' '. $sepet['soyad'] : ''; ?></td>
                                            <td><?= $sepet['firmaUnvani'] ?? ''; ?></td>
                                            <td><?= $sepet['email'] ?? ''; ?></td>
                                            <td><?= $sepet['tel'] ?? ''; ?></td>
                                            <td><?= $sepet['tarih'] ?? ''; ?></td>
                                            <td>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <table id="musteriTablo" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                    <?php
                    $urun = $database->fetchAll("SELECT muhasebe_kodu, firmaUnvani, ad, soyad, id FROM uyeler WHERE satis_temsilcisi = :id ", ['id' => $satis_id]);
