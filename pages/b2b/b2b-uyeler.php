        ...
        var table = $('#deneme').DataTable({
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function (data, type, row) {
                        return `
                                <button type="button" class="btn btn-sm btn-danger" onclick="dynamicSil('${data.id}', '', 'uye', 'Üye Silindi!', 'pages/b2b/b2b-uyeler.php?w=b2b');" data-toggle="tooltip" title="Sil"><i class="fa-solid fa-trash-can"></i></button>
